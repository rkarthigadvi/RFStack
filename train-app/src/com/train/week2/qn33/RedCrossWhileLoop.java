...
public class RedCrossWhileLoop {

	public static void main(String[] args) {

		/*
		 * Question 33 : The Red Cross (while loop) On an event of a natural calamity, Red
		 ...
		 * using while loop iterate the number of tents and ask the user to enter number of refugess present in each tent
